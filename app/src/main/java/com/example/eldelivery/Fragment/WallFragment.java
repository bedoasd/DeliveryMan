...
public class WallFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        orders_list.add(new Wall_Delivery_Order_Model("salama","cairo","alex","100"));
        orders_list.add(new Wall_Delivery_Order_Model("ALi Ahmed ","shaikh khali","sa7ep el dewan","15"));
        orders_list.add(new Wall_Delivery_Order_Model("omar","elshare3 el geded","el mahata","20"));
        orders_list.add(new Wall_Delivery_Order_Model("mona","cairo","kafreldawar","56"));
        orders_list.add(new Wall_Delivery_Order_Model("salwa","aswan","alex","1500"));
